...
ALTER TABLE "assignees" ADD CONSTRAINT "fk_assignees_activity_issue_id" FOREIGN KEY ("issue_id") REFERENCES "issues" ("id");
ALTER TABLE "assignees" ADD CONSTRAINT "fk_assignees_activity_pr_id" FOREIGN KEY ("pr_id") REFERENCES "pull_requests" ("id");
...
ALTER TABLE "assigned_labals" ADD CONSTRAINT "fk_assigned_labals_activity_issue_id" FOREIGN KEY ("issue_id") REFERENCES "issues" ("id");
ALTER TABLE "assigned_labals" ADD CONSTRAINT "fk_assigned_labals_activity_pull_requests_id" FOREIGN KEY ("pr_id") REFERENCES "pull_requests" ("id");
